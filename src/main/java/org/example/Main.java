...
public class Main {
    public static void main(String[] args) {
        ...
        Task bobsTask2 = new Task(  "workintech",  "dummy desc 4",  "bob", Status.IN_PROGRESS, Priority.HIGH);

        bobsTasks.add(bobsTask);
        bobsTasks.add(bobsTask2);

        Set<Task> carolsTasks = new HashSet<>();
        Task carolsTask = new Task( "workintech",  "dummy desc 5",  "carol", Status.IN_PROGRESS, Priority.HIGH);
        Task carolsTask2 = new Task(  "workintech",  "dummy desc 6",  "carol", Status.IN_PROGRESS, Priority.HIGH);
